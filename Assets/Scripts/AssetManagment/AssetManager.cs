...
using System.Linq;
using AssetManagment.Exceptions;
...
namespace AssetManagment
{
    public class AssetManager : MonoBehaviorSingleton<AssetManager>
    {
        ...
        readonly Dictionary<object, AsyncOperationHandle> _loadingAssets = new Dictionary<object, AsyncOperationHandle>(20);
        readonly Dictionary<object, AsyncOperationHandle> _loadedAssets = new Dictionary<object, AsyncOperationHandle>(100);
        public  IReadOnlyList<object> LoadedAssets => _loadedAssets.Values.Select(x => x.Result).ToList();
         readonly Dictionary<object, List<GameObject>> _instantiatedObjects = new Dictionary<object, List<GameObject>>(10);

        public  int loadedAssetsCount => _loadedAssets.Count;
        public  int loadingAssetsCount => _loadingAssets.Count;
        public  int instantiatedAssetsCount => _instantiatedObjects.Values.SelectMany(x => x).Count();

        #region Get
        public  bool IsLoaded(AssetReference aRef)
        {
            return _loadedAssets.ContainsKey(aRef.RuntimeKey);
        }
         bool IsLoaded(object key)
        {
            return _loadedAssets.ContainsKey(key);
        }
        public  bool IsLoading(AssetReference aRef)
        {
            return _loadingAssets.ContainsKey(aRef.RuntimeKey);
        }
         bool IsLoading(object key)
        {
            return _loadingAssets.ContainsKey(key);
        }
        public  bool IsInstantiated(AssetReference aRef)
        {
            return _instantiatedObjects.ContainsKey(aRef.RuntimeKey);
        }
        public  bool IsInstantiated(object key)
        {
            return _instantiatedObjects.ContainsKey(key);
        }
        public  int InstantiatedCount(AssetReference aRef)
        {
        ...
        public  bool TryGetOrLoadObjectAsync<TObjectType>(AssetReference aRef, out AsyncOperationHandle<TObjectType> handle) where TObjectType : Object
        {
        ...
        /// <typeparam name="TObjectType">The type of NON-COMPONENT object to load.</typeparam>
        /// <returns><value>true</value> if the object has already been loaded, false otherwise.</returns>
        public  bool TryGetOrLoadObjectAsync<TObjectType>(AssetReferenceT<TObjectType> aRef, out AsyncOperationHandle<TObjectType> handle) where TObjectType : Object
        {
        ...
        /// <returns><value>true</value> if the object has already been loaded, false otherwise.</returns>
        public  bool TryGetOrLoadComponentAsync<TComponentType>(AssetReference aRef, out AsyncOperationHandle<TComponentType> handle) where TComponentType : Component
        {
            CheckRuntimeKey(aRef);
        ...
        /// <typeparam name="TComponentType">The type of Component to load.</typeparam>
        /// <returns><value>true</value> if the object has already been loaded, false otherwise.</returns>
        public  bool TryGetOrLoadComponentAsync<TComponentType>(AssetReferenceT<TComponentType> aRef, out AsyncOperationHandle<TComponentType> handle) where TComponentType : Component
        {
            return TryGetOrLoadComponentAsync(aRef as AssetReference, out handle);
        }
        
        public  bool TryGetObjectSync<TObjectType>(AssetReference aRef, out TObjectType result) where TObjectType : Object
        {
            CheckRuntimeKey(aRef);
            var key = aRef.RuntimeKey;
        ...
        public  bool TryGetObjectSync<TObjectType>(AssetReferenceT<TObjectType> aRef, out TObjectType result) where TObjectType : Object
        {
            return TryGetObjectSync(aRef as AssetReference, out result);
        }

        public  bool TryGetComponentSync<TComponentType>(AssetReference aRef, out TComponentType result) where TComponentType : Component
        {
            CheckRuntimeKey(aRef);
            var key = aRef.RuntimeKey;
        ...
        public  bool TryGetComponentSync<TComponentType>(AssetReferenceT<TComponentType> aRef, out TComponentType result) where TComponentType : Component
        {
        ...
        public  AsyncOperationHandle<List<AsyncOperationHandle<Object>>> LoadAssetsByLabelAsync(string label)
        {
         ...
         void AssetLoadedCallback(object key, AsyncOperationHandle handle)
        {
        ...
        /// <returns></returns>
        public  void Unload(AssetReference aRef)
        {
            CheckRuntimeKey(aRef);
        ...
        public  bool TryInstantiateOrLoadAsync(AssetReference aRef, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateOrLoadAsync<TComponentType>(AssetReference aRef, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateOrLoadAsync<TComponentType>(AssetReferenceT<TComponentType> aRef, Vector3 position, Quaternion rotation, Transform parent,
            out AsyncOperationHandle<TComponentType> handle) where TComponentType : Component
        {
            return TryInstantiateOrLoadAsync(aRef as AssetReference, position, rotation, parent, out handle);
        }

        public  bool TryInstantiateMultiOrLoadAsync(AssetReference aRef, int count, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateMultiOrLoadAsync<TComponentType>(AssetReference aRef, int count, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateMultiOrLoadAsync<TComponentType>(AssetReferenceT<TComponentType> aRef, int count, Vector3 position, Quaternion rotation,
        ...
        public  bool TryInstantiateSync(AssetReference aRef, Vector3 position, Quaternion rotation, Transform parent, out GameObject result)
        {
        ...
        public  bool TryInstantiateSync<TComponentType>(AssetReference aRef, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateSync<TComponentType>(AssetReferenceT<TComponentType> aRef, Vector3 position, Quaternion rotation, Transform parent,
            out TComponentType result) where TComponentType : Component
        {
            return TryInstantiateSync(aRef as AssetReference, position, rotation, parent, out result);
        }

        public  bool TryInstantiateMultiSync(AssetReference aRef, int count, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateMultiSync<TComponentType>(AssetReference aRef, int count, Vector3 position, Quaternion rotation, Transform parent,
        ...
        public  bool TryInstantiateMultiSync<TComponentType>(AssetReferenceT<TComponentType> aRef, int count, Vector3 position, Quaternion rotation, Transform parent,
            out List<TComponentType> result) where TComponentType : Component
        {
            return TryInstantiateMultiSync(aRef as AssetReference, count, position, rotation, parent, out result);
        }

         TComponentType InstantiateInternal<TComponentType>(AssetReference aRef, TComponentType loadedAsset, Vector3 position, Quaternion rotation, Transform parent)
            where TComponentType : Component
        {
         ...
         GameObject InstantiateInternal(AssetReference aRef, GameObject loadedAsset, Vector3 position, Quaternion rotation, Transform parent)
        {
            var key = aRef.RuntimeKey;
         ...
         void TrackerDestroyed(MonoTracker tracker)
        {
        ...
        public  void DestroyAllInstances(AssetReference aRef)
        {
         ...
         void DestroyAllInstances(object key)
        {
         ...
         void DestroyInternal(Object obj)
        {
        ...
        #region Utilities
         void CheckRuntimeKey(AssetReference aRef)
        {
         ...
         bool CheckRuntimeKey(object key)
        {
            return Guid.TryParse(key.ToString(), out var result);
        }
        
         AsyncOperationHandle<TComponentType> ConvertHandleToComponent<TComponentType>(AsyncOperationHandle handle) where TComponentType : Component
        {

    ...
    public class CurveUtil
    {
        ...
        public static Vector3[] CirclePointsAroundZ(Vector3 startPoint, Vector3 center, float degAngle, int pointsCount)
        {
           ...
           // float startAngle = Mathf.Deg2Rad * Vector2.Angle((startPoint - center), Vector2.right);
            float startAngle = Mathf.Deg2Rad *  MathUtil.GetFullAngleOX((startPoint - center));
        ...
        {
            float radStart = Mathf.Deg2Rad * MathUtil.GetFullAngleOX(startDirection);
            Debug.Log("startAngle" + MathUtil.GetFullAngleOX(startDirection));
            ...
            float radEnd = Mathf.Deg2Rad * MathUtil.GetFullAngleOX(endDirection);
            Debug.Log("endAngle" + MathUtil.GetFullAngleOX(endDirection));
            float dAngle = (radEnd - radStart) / (pointsCount - 1);

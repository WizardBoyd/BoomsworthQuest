...
namespace Misc.FileManagment
{
    public static class FileManager
    {
        ...
        /// <summary>
        /// Checks to see if the filename exists in the persistant data path
        /// </summary>
        /// <param name="FileName"> the file name that's being checked for</param>

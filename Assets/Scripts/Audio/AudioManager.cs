...
namespace Audio
{
	...
	[SerializeField] private BoolEventChannelSO _SFXVolumeEventChannel = default;
	[Tooltip("The SoundManager listens to this event, fired by objects in any scene, to change Music volume")]
	[SerializeField] private BoolEventChannelSO _musicVolumeEventChannel = default;
	[Tooltip("The SoundManager listens to this event, fired by objects in any scene, to change Master volume")]
	[SerializeField] private BoolEventChannelSO _masterVolumeEventChannel = default;
	...
	void ChangeMasterVolume(bool newVolume)
	{
		//_masterVolume = newVolume;
		SetGroupVolume("MasterVolume", _masterVolume);
	}
	void ChangeMusicVolume(bool newVolume)
	{
		//_musicVolume = newVolume;
		SetGroupVolume("MusicVolume", _musicVolume);
	}
	void ChangeSFXVolume(bool newVolume)
	{
